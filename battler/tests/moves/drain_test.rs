    ...
    fn drain_moves_heal_a_percent_of_damage_dealt() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:0",
                "damage|mon:Venusaur,player-1,1|health:209/270",
                ...
                "split|side:0",
                "heal|mon:Venusaur,player-1,1|from:Drain|of:Machamp,player-2,1|health:261/270",
                "heal|mon:Venusaur,player-1,1|from:Drain|of:Machamp,player-2,1|health:97/100",
                "move|mon:Machamp,player-2,1|name:Vital Throw|target:Venusaur,player-1,1",
                "resisted|mon:Venusaur,player-1,1",
                "split|side:0",
                "damage|mon:Venusaur,player-1,1|health:199/270",

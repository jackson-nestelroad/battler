...
fn mimic_overwrites_move_slot_as_volatile() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "start|mon:Wigglytuff,player-1,1|move:Mimic|mimic:Quick Attack",
            "residual",
            "turn|turn:3",
            "continue",
            "move|mon:Flareon,player-2,2|name:Quick Attack|target:Wigglytuff,player-1,1",
            ...
            "continue",
            "move|mon:Wigglytuff,player-1,1|name:Mimic|target:Flareon,player-2,2",
            "start|mon:Wigglytuff,player-1,1|move:Mimic|mimic:Flamethrower",
            "residual",
            "turn|turn:7",
            "continue",
...
fn mimic_fails_on_moves_marked_fail_mimic() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "start|mon:Wigglytuff,player-2,1|move:Mimic|mimic:Flamethrower",
            "residual",
            "turn|turn:2",
            "continue",
            "move|mon:Wigglytuff,player-1,1|name:Mimic|noanim",

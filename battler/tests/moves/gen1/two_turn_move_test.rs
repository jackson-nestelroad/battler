...
fn fly_grants_invulnerability() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "addvolatile|mon:Pidgeot,player-1,1|volatile:Two Turn Move|from:move:Fly|of:Pidgeot,player-2,1",
            "residual",
            "turn|turn:2",
            "continue",
            ...
            "removevolatile|mon:Pidgeot,player-1,1|volatile:Fly|from:move:Fly|of:Pidgeot,player-2,1",
...
fn fly_locks_target() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "prepare|mon:Pidgeot,player-1,1|move:Fly",
            "addvolatile|mon:Pidgeot,player-1,1|volatile:Fly|from:Two Turn Move",
            "addvolatile|mon:Pidgeot,player-1,1|volatile:Two Turn Move|from:move:Fly|of:Pidgeot,player-2,2",
            "residual",
            "turn|turn:2",
            "continue",
            "move|mon:Pidgeot,player-1,1|name:Fly|target:Pidgeot,player-2,2",
            "removevolatile|mon:Pidgeot,player-1,1|volatile:Fly|from:move:Fly|of:Pidgeot,player-2,2",
            "removevolatile|mon:Pidgeot,player-1,1|volatile:Two Turn Move|from:move:Fly",
            "split|side:1",
...
fn skull_bash_also_boosts_defense() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "addvolatile|mon:Blastoise,player-1,1|volatile:Two Turn Move|from:move:Skull Bash|of:Blastoise,player-2,1",
            "residual",
            "turn|turn:2",
            "continue",
            "move|mon:Blastoise,player-1,1|name:Skull Bash|target:Blastoise,player-2,1",
            "removevolatile|mon:Blastoise,player-1,1|volatile:Skull Bash|from:move:Skull Bash|of:Blastoise,player-2,1",

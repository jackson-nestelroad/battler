...
fn heals_percent_of_user_hp() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "split|side:1",
            "damage|mon:Charizard,player-2,1|health:90/266",
            "damage|mon:Charizard,player-2,1|health:34/100",
            "move|mon:Charizard,player-2,1|name:Thunderbolt|target:Charizard,player-1,1",
            "supereffective|mon:Charizard,player-1,1",
            "split|side:0",
            "damage|mon:Charizard,player-1,1|health:84/266",
            "damage|mon:Charizard,player-1,1|health:32/100",
            "residual",
            "turn|turn:2",
            "continue",
            "move|mon:Charizard,player-1,1|name:Recover|target:Charizard,player-1,1",
            "split|side:0",
            "heal|mon:Charizard,player-1,1|health:217/266",
            "heal|mon:Charizard,player-1,1|health:82/100",
            "move|mon:Charizard,player-2,1|name:Recover|target:Charizard,player-2,1",
            "split|side:1",
            "heal|mon:Charizard,player-2,1|health:223/266",
            "heal|mon:Charizard,player-2,1|health:84/100",
            "residual",
            "turn|turn:3",
            "continue",
            "move|mon:Charizard,player-1,1|name:Recover|target:Charizard,player-1,1",
...
fn heals_all_allies() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "split|side:0",
            "damage|mon:Blastoise,player-1,1|health:156/268",
            "damage|mon:Blastoise,player-1,1|health:59/100",
            "split|side:1",
            "damage|mon:Blastoise,player-2,1|health:163/268",
            "damage|mon:Blastoise,player-2,1|health:61/100",
            "split|side:1",
            "damage|mon:Golem,player-2,2|health:106/270",
            "damage|mon:Golem,player-2,2|health:40/100",
            ...
            "split|side:1",
            "damage|mon:Blastoise,player-2,1|health:55/268",
            "damage|mon:Blastoise,player-2,1|health:21/100",
            "split|side:0",
            "damage|mon:Blastoise,player-1,1|health:53/268",
            "damage|mon:Blastoise,player-1,1|health:20/100",
            "split|side:0",
            "damage|mon:Golem,player-1,2|health:112/270",
            "damage|mon:Golem,player-1,2|health:42/100",
            "residual",
            "turn|turn:2",
            "continue",
            "move|mon:Blastoise,player-1,1|name:Life Dew|spread:Blastoise,player-1,1;Golem,player-1,2",
            "split|side:0",
            "heal|mon:Blastoise,player-1,1|health:120/268",
            "heal|mon:Blastoise,player-1,1|health:45/100",
            "split|side:0",
            "heal|mon:Golem,player-1,2|health:179/270",
            "heal|mon:Golem,player-1,2|health:67/100",
            "move|mon:Blastoise,player-2,1|name:Life Dew|spread:Blastoise,player-2,1;Golem,player-2,2",
            "split|side:1",
            "heal|mon:Blastoise,player-2,1|health:122/268",
            "heal|mon:Blastoise,player-2,1|health:46/100",
            "split|side:1",
            "heal|mon:Golem,player-2,2|health:173/270",
            "heal|mon:Golem,player-2,2|health:65/100",
            "residual",
            "turn|turn:3"
        ]"#,
    )

...
fn metronome_uses_random_move() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "move|mon:Togepi,player-1,1|name:Absorb|target:Togepi,player-2,1",
            "split|side:1",
            ...
            "move|mon:Togepi,player-2,1|name:Self-Destruct|spread:Togepi,player-2,2;Togepi,player-1,1;Togepi,player-1,2",
            "split|side:1",
            ...
            "move|mon:Togepi,player-2,2|name:Pin Missile|target:Togepi,player-1,1",

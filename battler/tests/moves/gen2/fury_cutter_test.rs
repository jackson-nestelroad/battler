    ...
    fn fury_cutter_doubles_power_for_consecutive_hits() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "residual",
                ["time"],
                "switch|player:player-2|position:1|name:Blissey|health:100/100|species:Blissey|level:100|gender:F",
                "turn|turn:4",
                ["time"],
                "move|mon:Scizor,player-1,1|name:Fury Cutter|target:Blissey,player-2,1",
                "split|side:1",
                ...
                "status|mon:Blissey,player-2,1|status:Sleep|from:move:Rest",
                "split|side:1",

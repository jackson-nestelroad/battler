...
fn conversion_2_changes_type_based_on_targets_last_move() {
    let mut battle = make_battle(0, porygon2().unwrap(), porygon2().unwrap()).unwrap();
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "typechange|mon:Porygon2,player-1,1|types:Rock|from:move:Conversion 2",
            "residual",
            "turn|turn:4",
            "continue",
            "move|mon:Porygon2,player-1,1|name:Conversion 2|target:Porygon2,player-2,1",
            "typechange|mon:Porygon2,player-1,1|types:Ghost|from:move:Conversion 2",
            "residual",
            "turn|turn:5",
            "continue",
            ...
            "continue",
            "move|mon:Porygon2,player-1,1|name:Conversion 2|target:Porygon2,player-2,1",
            "typechange|mon:Porygon2,player-1,1|types:Dragon|from:move:Conversion 2",
            "residual",
            "turn|turn:7"
        ]"#,
    )

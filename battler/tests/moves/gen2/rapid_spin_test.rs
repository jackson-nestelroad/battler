    ...
    fn rapid_spin_clears_user_entry_hazards() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "damage|mon:Forretress,player-2,1|health:128/135",
                "damage|mon:Forretress,player-2,1|health:95/100",
                "end|mon:Forretress,player-1,1|move:Bind|from:move:Rapid Spin",
                "end|mon:Forretress,player-1,1|move:Leech Seed|from:move:Rapid Spin",
                "sideend|side:0|move:Spikes|from:move:Rapid Spin",
                "sideend|side:0|move:Toxic Spikes|from:move:Rapid Spin",
                "residual",
                "turn|turn:7"
            ]"#,
        )

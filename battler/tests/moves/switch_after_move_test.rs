    ...
    fn move_can_force_switch_random_target() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "switch|player:player-2|position:1|name:Squirtle|health:100/100|species:Squirtle|level:50|gender:M",
                "residual",
                "turn|turn:2",
                ["time"],
                ...
                "turn|turn:3",
                ["time"],
                "move|mon:Charmander,player-2,1|name:Tackle|target:Bulbasaur,player-1,1",
                "split|side:0",
                "damage|mon:Bulbasaur,player-1,1|health:55/105",
                "damage|mon:Bulbasaur,player-1,1|health:53/100",
                "move|mon:Bulbasaur,player-1,1|name:Roar|target:Charmander,player-2,1",
                "switch|player:player-2|position:1|name:Bulbasaur|health:100/100|species:Bulbasaur|level:50|gender:M",
                "residual",
                "turn|turn:4",
                ["time"],

...
fn rototiller_boosts_attack_of_grounded_grass_types() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "move|mon:Chesnaught,player-1,1|name:Rototiller|spread:Chesnaught,player-1,1;Delphox,player-1,2;Chesnaught,player-2,1;Delphox,player-2,2;Gogoat,player-2,3",
            "immune|mon:Gogoat,player-1,3",
            "boost|mon:Chesnaught,player-1,1|stat:atk|by:1",
            "boost|mon:Chesnaught,player-1,1|stat:spa|by:1",
            "boost|mon:Delphox,player-1,2|stat:atk|by:1",
            "boost|mon:Delphox,player-1,2|stat:spa|by:1",
            "boost|mon:Chesnaught,player-2,1|stat:atk|by:1",
            "boost|mon:Chesnaught,player-2,1|stat:spa|by:1",
            "boost|mon:Delphox,player-2,2|stat:atk|by:1",
            "boost|mon:Delphox,player-2,2|stat:spa|by:1",

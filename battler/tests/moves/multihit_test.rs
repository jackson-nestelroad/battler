    ...
    fn multihit_number_in_range() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:0",
                "damage|mon:Bulbasaur,player-1,1|health:61/105",
                "damage|mon:Bulbasaur,player-1,1|health:59/100",
                "hitcount|hits:2",
                "move|mon:Bulbasaur,player-1,1|name:Fury Attack|target:Bulbasaur,player-2,1",
                "split|side:1",
                "damage|mon:Bulbasaur,player-2,1|health:45/105",
                "damage|mon:Bulbasaur,player-2,1|health:43/100",
                "split|side:1",
                "damage|mon:Bulbasaur,player-2,1|health:38/105",
                "damage|mon:Bulbasaur,player-2,1|health:37/100",
                "split|side:1",

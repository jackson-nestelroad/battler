...
fn terrain_pulse_changes_type_based_on_effective_terrain() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "typechange|mon:Arboliva,player-2,1|types:Electric|from:ability:Color Change",
            "residual",
            "turn|turn:3",
            "continue",
            ...
            "typechange|mon:Arboliva,player-2,1|types:Grass|from:ability:Color Change",
            "split|side:1",
            ...
            "damage|mon:Arboliva,player-2,1|health:217/266",
            "damage|mon:Arboliva,player-2,1|health:82/100",
            "typechange|mon:Arboliva,player-2,1|types:Psychic|from:ability:Color Change",
            "residual",
            "turn|turn:5",
            "continue",
            ...
            "typechange|mon:Arboliva,player-2,1|types:Fairy|from:ability:Color Change",
            "residual",
            "turn|turn:6",
            "continue",
            ...
            "typechange|mon:Arboliva,player-2,1|types:Normal|from:ability:Color Change",
            "residual",
            "turn|turn:7"
        ]"#,
    )

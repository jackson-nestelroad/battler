    ...
    fn struggle_deals_recoil() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:0",
                "damage|mon:Blissey,player-1,1|health:557/620",
                "damage|mon:Blissey,player-1,1|health:90/100",
                "split|side:1",
                ...
                "split|side:1",
                "damage|mon:Blissey,player-2,1|health:405/620",
                "damage|mon:Blissey,player-2,1|health:66/100",
                "split|side:0",
                "damage|mon:Blissey,player-1,1|from:Struggle Recoil|health:402/620",
                "damage|mon:Blissey,player-1,1|from:Struggle Recoil|health:65/100",
                "residual",
                "turn|turn:2",
                ["time"],
                "move|mon:Blissey,player-1,1|name:Struggle|target:Blissey,player-2,1",
                "split|side:1",
                "damage|mon:Blissey,player-2,1|health:345/620",
                "damage|mon:Blissey,player-2,1|health:56/100",
                "split|side:0",
                "damage|mon:Blissey,player-1,1|from:Struggle Recoil|health:247/620",
                "damage|mon:Blissey,player-1,1|from:Struggle Recoil|health:40/100",
                "move|mon:Blissey,player-2,1|name:Struggle|target:Blissey,player-1,1",
                "split|side:0",
                "damage|mon:Blissey,player-1,1|health:187/620",
                "damage|mon:Blissey,player-1,1|health:31/100",
                "split|side:1",
                "damage|mon:Blissey,player-2,1|from:Struggle Recoil|health:190/620",
                "damage|mon:Blissey,player-2,1|from:Struggle Recoil|health:31/100",
                "residual",
                "turn|turn:3",
                ["time"],
                "move|mon:Blissey,player-1,1|name:Struggle|target:Blissey,player-2,1",
                "split|side:1",
                "damage|mon:Blissey,player-2,1|health:127/620",
                "damage|mon:Blissey,player-2,1|health:21/100",
                "split|side:0",
                "damage|mon:Blissey,player-1,1|from:Struggle Recoil|health:32/620",

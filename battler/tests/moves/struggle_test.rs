    ...
    fn struggle_deals_recoil() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:1",
                "damage|mon:Blissey,player-2,1|health:425/620",
                ...
                "move|mon:Blissey,player-1,1|name:Struggle|target:Blissey,player-2,1",
                "split|side:1",
                "damage|mon:Blissey,player-2,1|health:385/620",
                "damage|mon:Blissey,player-2,1|health:63/100",
                "split|side:0",
                ...
                "move|mon:Blissey,player-2,1|name:Struggle|target:Blissey,player-1,1",
                "split|side:0",
                "damage|mon:Blissey,player-1,1|health:228/620",
                "damage|mon:Blissey,player-1,1|health:37/100",
                "split|side:1",
                "damage|mon:Blissey,player-2,1|from:Struggle Recoil|health:230/620",
                "damage|mon:Blissey,player-2,1|from:Struggle Recoil|health:38/100",
                "residual",
                "turn|turn:3",
                ["time"],
                "move|mon:Blissey,player-1,1|name:Struggle|target:Blissey,player-2,1",
                "split|side:1",
                "damage|mon:Blissey,player-2,1|health:188/620",
                "damage|mon:Blissey,player-2,1|health:31/100",
                "split|side:0",
                "damage|mon:Blissey,player-1,1|from:Struggle Recoil|health:73/620",
                "damage|mon:Blissey,player-1,1|from:Struggle Recoil|health:12/100",
                "move|mon:Blissey,player-2,1|name:Struggle|target:Blissey,player-1,1",
                "split|side:0",
                "damage|mon:Blissey,player-1,1|health:30/620",
                "damage|mon:Blissey,player-1,1|health:5/100",
                "split|side:1",
                "damage|mon:Blissey,player-2,1|from:Struggle Recoil|health:33/620",
                "damage|mon:Blissey,player-2,1|from:Struggle Recoil|health:6/100",
                "residual",
                "turn|turn:4"
            ]"#).unwrap();

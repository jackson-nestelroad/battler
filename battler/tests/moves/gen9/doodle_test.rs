...
fn doodle_copies_target_ability_to_user_and_allies() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
                ...
                "abilitystart|mon:Grafaiai,player-1,1|ability:Speed Boost|source:Grafaiai,player-2,1|from:move:Doodle",
                "abilityend|mon:Grafaiai,player-1,2|ability:No Ability|from:move:Doodle|of:Grafaiai,player-1,1",
                "abilitystart|mon:Grafaiai,player-1,2|ability:Speed Boost|source:Grafaiai,player-2,1|from:move:Doodle|of:Grafaiai,player-1,1",
                "residual",

    ...
    fn recoils_based_on_damage_dealt() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:0",
                "damage|mon:Slaking,player-1,1|health:172/410",
                "damage|mon:Slaking,player-1,1|health:42/100",
                "split|side:1",
                "damage|mon:Slaking,player-2,1|from:Recoil|health:331/410",
                ...
                "split|side:1",
                "damage|mon:Slaking,player-2,1|health:129/410",
                "damage|mon:Slaking,player-2,1|health:32/100",
                "split|side:0",
                "damage|mon:Slaking,player-1,1|from:Recoil|health:105/410",

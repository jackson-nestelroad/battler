    ...
    fn heals_percent_of_user_hp() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:1",
                "damage|mon:Charizard,player-2,1|health:100/266",
                ...
                "split|side:1",
                "heal|mon:Charizard,player-2,1|health:233/266",
                "heal|mon:Charizard,player-2,1|health:88/100",
                "residual",
                "turn|turn:3",
                ["time"],
                "move|mon:Charizard,player-1,1|name:Recover|target:Charizard,player-1,1",
    ...
    fn heals_all_allies() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:0",
                "damage|mon:Golem,player-1,2|health:100/270",
                "damage|mon:Golem,player-1,2|health:38/100",
                ...
                "split|side:1",
                "damage|mon:Golem,player-2,2|health:124/270",
                "damage|mon:Golem,player-2,2|health:46/100",
                "residual",
                "turn|turn:2",
                ["time"],
                "move|mon:Blastoise,player-2,1|name:Life Dew|spread:Golem,player-2,2;Blastoise,player-2,1",
                "split|side:1",
                "heal|mon:Golem,player-2,2|health:192/270",
                "heal|mon:Golem,player-2,2|health:72/100",
                "split|side:1",
                ...
                "split|side:0",
                "heal|mon:Golem,player-1,2|health:168/270",
                "heal|mon:Golem,player-1,2|health:63/100",
                "split|side:0",

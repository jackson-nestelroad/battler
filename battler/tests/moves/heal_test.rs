    ...
    fn heals_percent_of_user_hp() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:0",
                "damage|mon:Charizard,player-1,1|health:74/266",
                "damage|mon:Charizard,player-1,1|health:28/100",
                "move|mon:Charizard,player-1,1|name:Thunderbolt|target:Charizard,player-2,1",
                "supereffective|mon:Charizard,player-2,1",
                "split|side:1",
                "damage|mon:Charizard,player-2,1|health:82/266",
                "damage|mon:Charizard,player-2,1|health:31/100",
                "residual",
                "turn|turn:2",
                ["time"],
                "move|mon:Charizard,player-2,1|name:Recover|target:Charizard,player-2,1",
                "split|side:1",
                "heal|mon:Charizard,player-2,1|health:215/266",
                "heal|mon:Charizard,player-2,1|health:81/100",
                "move|mon:Charizard,player-1,1|name:Recover|target:Charizard,player-1,1",
                "split|side:0",
                "heal|mon:Charizard,player-1,1|health:207/266",
                "heal|mon:Charizard,player-1,1|health:78/100",
                "residual",
                "turn|turn:3",
                ["time"],
                "move|mon:Charizard,player-2,1|name:Recover|target:Charizard,player-2,1",

...
fn stockpile_changes_effect_of_spit_up() {
    let mut battle = make_battle(0, pelipper().unwrap(), pelipper().unwrap()).unwrap();
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "boost|mon:Pelipper,player-1,1|stat:def|by:1|from:move:Stockpile",
            "boost|mon:Pelipper,player-1,1|stat:spd|by:1|from:move:Stockpile",
            ...
            "boost|mon:Pelipper,player-2,1|stat:def|by:1|from:move:Stockpile",
            "boost|mon:Pelipper,player-2,1|stat:spd|by:1|from:move:Stockpile",
            "residual",
            "turn|turn:2",
            "continue",
            "move|mon:Pelipper,player-1,1|name:Stockpile|target:Pelipper,player-1,1",
            ...
            "unboost|mon:Pelipper,player-2,1|stat:def|by:1|from:move:Stockpile",
            "unboost|mon:Pelipper,player-2,1|stat:spd|by:1|from:move:Stockpile",
            ...
            "unboost|mon:Pelipper,player-1,1|stat:def|by:3|from:move:Stockpile",
            "unboost|mon:Pelipper,player-1,1|stat:spd|by:3|from:move:Stockpile",

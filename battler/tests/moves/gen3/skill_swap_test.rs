...
fn skill_swap_swaps_abilities() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
                ...
                "abilitystart|mon:Plusle,player-1,1|ability:Drizzle|source:Plusle,player-2,1|from:move:Skill Swap",
                "abilityend|mon:Plusle,player-2,1|ability:Drizzle|from:move:Skill Swap|of:Plusle,player-1,1",
                "abilitystart|mon:Plusle,player-2,1|ability:Soundproof|source:Plusle,player-1,1|from:move:Skill Swap|of:Plusle,player-1,1",
                "residual",

...
fn trick_switches_items_with_target() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
                ...
                "itemstart|mon:Torchic,player-1,1|item:Choice Band|source:Torchic,player-2,1|from:move:Trick",
                "itemstart|mon:Torchic,player-2,1|item:Safety Goggles|source:Torchic,player-1,1|from:move:Trick|of:Torchic,player-1,1",
                "move|mon:Torchic,player-2,1|name:Tackle|target:Torchic,player-1,1",
                "split|side:0",
...
#[test]
fn switcheroo_switches_items_with_target() {
    let mut team_1 = torchic().unwrap();
    team_1.members[0].item = Some("Safety Goggles".to_owned());
    let mut team_2 = torchic().unwrap();
    team_2.members[0].item = Some("Choice Band".to_owned());
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
                ...
                "turn|turn:2",
                "continue",
                "move|mon:Torchic,player-1,1|name:Switcheroo|target:Torchic,player-2,1",
                "itemend|mon:Torchic,player-2,1|item:Choice Band|from:move:Switcheroo|of:Torchic,player-1,1",
                "itemend|mon:Torchic,player-1,1|item:Safety Goggles|from:move:Switcheroo",
                "itemstart|mon:Torchic,player-1,1|item:Choice Band|source:Torchic,player-2,1|from:move:Switcheroo",
                "itemstart|mon:Torchic,player-2,1|item:Safety Goggles|source:Torchic,player-1,1|from:move:Switcheroo|of:Torchic,player-1,1",
                "move|mon:Torchic,player-2,1|name:Tackle|target:Torchic,player-1,1",
                "split|side:0",
                "damage|mon:Torchic,player-1,1|health:44/105",
                "damage|mon:Torchic,player-1,1|health:42/100",

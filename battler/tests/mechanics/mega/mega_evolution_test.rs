...
fn one_mon_can_mega_evolve() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "abilityend|mon:Charizard,player-2,1|ability:Blaze|from:move:Skill Swap",
            "abilitystart|mon:Charizard,player-2,1|ability:Thick Fat|source:Venusaur,player-1,1|from:move:Skill Swap",
            "abilityend|mon:Venusaur,player-1,1|ability:Thick Fat|from:move:Skill Swap|of:Charizard,player-2,1",
            "abilitystart|mon:Venusaur,player-1,1|ability:Blaze|source:Charizard,player-2,1|from:move:Skill Swap|of:Charizard,player-2,1",
            "residual",
            "turn|turn:5"
        ]"#,
    )
...
fn mega_evolution_reverts_on_faint() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "activate|mon:Venusaur,player-1,1|move:Skill Swap|of:Charizard,player-2,1",
            "abilityend|mon:Charizard,player-2,1|ability:Blaze|from:move:Skill Swap",
            "abilitystart|mon:Charizard,player-2,1|ability:Chlorophyll|source:Venusaur,player-1,1|from:move:Skill Swap",

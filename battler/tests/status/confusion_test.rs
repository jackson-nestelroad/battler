...
fn confusion_can_hurt_user_and_wears_off_naturally() {
    let mut battle = make_battle(crobat().unwrap(), crobat().unwrap()).unwrap();
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
            "split|side:1",
            "damage|mon:Crobat,player-2,1|health:108/145",
            "damage|mon:Crobat,player-2,1|health:75/100",
            "activate|mon:Crobat,player-2,1|condition:Confusion",
            "move|mon:Crobat,player-2,1|name:Tackle|target:Crobat,player-1,1",
            "split|side:0",
            ...
            "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
            "split|side:1",
            "damage|mon:Crobat,player-2,1|health:91/145",
            "damage|mon:Crobat,player-2,1|health:63/100",
            "activate|mon:Crobat,player-2,1|condition:Confusion",
            "split|side:1",
            "damage|mon:Crobat,player-2,1|from:Confusion|health:73/145",
            "damage|mon:Crobat,player-2,1|from:Confusion|health:51/100",
            "residual",
            "turn|turn:5",
            ["time"],
            "activate|mon:Crobat,player-1,1|condition:Confusion",
            "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
            "split|side:1",
            "damage|mon:Crobat,player-2,1|health:55/145",
            "damage|mon:Crobat,player-2,1|health:38/100",
            "end|mon:Crobat,player-2,1|condition:Confusion",
            "move|mon:Crobat,player-2,1|name:Tackle|target:Crobat,player-1,1",
            "split|side:0",
            "damage|mon:Crobat,player-1,1|health:89/145",
            "damage|mon:Crobat,player-1,1|health:62/100",
            "residual",
            "turn|turn:6",
            ["time"],
            ...
            "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
            "split|side:1",
            "damage|mon:Crobat,player-2,1|health:37/145",
            "damage|mon:Crobat,player-2,1|health:26/100",
            "move|mon:Crobat,player-2,1|name:Tackle|target:Crobat,player-1,1",
            "split|side:0",
            "damage|mon:Crobat,player-1,1|health:69/145",
            "damage|mon:Crobat,player-1,1|health:48/100",
            "residual",
            "turn|turn:7"
        ]"#,
    )

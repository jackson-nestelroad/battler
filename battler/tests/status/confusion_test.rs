    ...
    fn confusion_can_hurt_user_and_wears_off_naturally() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:1",
                "damage|mon:Crobat,player-2,1|from:Confusion|health:128/145",
                "damage|mon:Crobat,player-2,1|from:Confusion|health:89/100",
                "end|mon:Crobat,player-1,1|condition:Confusion",
                "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
                "split|side:1",
                "damage|mon:Crobat,player-2,1|health:109/145",
                "damage|mon:Crobat,player-2,1|health:76/100",
                "residual",
                "turn|turn:3",
                ["time"],
                "activate|mon:Crobat,player-2,1|condition:Confusion",
                ...
                "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
                "split|side:1",
                "damage|mon:Crobat,player-2,1|health:90/145",
                "damage|mon:Crobat,player-2,1|health:63/100",
                "residual",
                "turn|turn:4",
                ["time"],
                "activate|mon:Crobat,player-2,1|condition:Confusion",
                "move|mon:Crobat,player-2,1|name:Tackle|target:Crobat,player-1,1",
                "split|side:0",
                "damage|mon:Crobat,player-1,1|health:106/145",
                "damage|mon:Crobat,player-1,1|health:74/100",
                "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
                "split|side:1",
                "damage|mon:Crobat,player-2,1|health:71/145",
                "damage|mon:Crobat,player-2,1|health:49/100",
                "residual",
                "turn|turn:5",
                ["time"],
                "activate|mon:Crobat,player-2,1|condition:Confusion",
                "move|mon:Crobat,player-2,1|name:Tackle|target:Crobat,player-1,1",
                "split|side:0",
                "damage|mon:Crobat,player-1,1|health:87/145",
                "damage|mon:Crobat,player-1,1|health:60/100",
                "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
                "split|side:1",
                "damage|mon:Crobat,player-2,1|health:52/145",
                "damage|mon:Crobat,player-2,1|health:36/100",
                "residual",
                "turn|turn:6",
                ["time"],
                ...
                "move|mon:Crobat,player-2,1|name:Tackle|target:Crobat,player-1,1",
                "split|side:0",
                "damage|mon:Crobat,player-1,1|health:67/145",
                "damage|mon:Crobat,player-1,1|health:47/100",
                "move|mon:Crobat,player-1,1|name:Tackle|target:Crobat,player-2,1",
                "split|side:1",
                "damage|mon:Crobat,player-2,1|health:31/145",
                "damage|mon:Crobat,player-2,1|health:22/100",
                "residual",
                "turn|turn:7"
            ]"#,
        )

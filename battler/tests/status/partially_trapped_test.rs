    ...
    fn bind_partially_traps_target() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                "split|side:1",
                "damage|mon:Gyarados,player-2,1|from:Partially Trapped|health:124/155",
                "damage|mon:Gyarados,player-2,1|from:Partially Trapped|health:80/100",
                "residual",
                "turn|turn:2",
                ["time"],
                "split|side:1",
                "damage|mon:Gyarados,player-2,1|from:Partially Trapped|health:105/155",
                "damage|mon:Gyarados,player-2,1|from:Partially Trapped|health:68/100",
                "residual",
                "turn|turn:3",
                ["time"],
                "split|side:1",
                "damage|mon:Gyarados,player-2,1|from:Partially Trapped|health:86/155",
                "damage|mon:Gyarados,player-2,1|from:Partially Trapped|health:56/100",
                "residual",
                "turn|turn:4",
                ["time"],
                "split|side:1",
                "damage|mon:Gyarados,player-2,1|from:Partially Trapped|health:67/155",
                "damage|mon:Gyarados,player-2,1|from:Partially Trapped|health:44/100",
                "residual",
                "turn|turn:5",
                ["time"],
                "end|mon:Gyarados,player-2,1|what:Bind",
                "residual",
                "turn|turn:6",
                ["time"],
                "residual",
    ...
    fn bind_ends_when_user_switches() {
        ...
        let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
            r#"[
                ...
                ["time"],
                "switch|player:player-1|position:1|name:Gyarados|health:100/100|species:Gyarados|level:50|gender:M",
                "end|mon:Gyarados,player-2,1|what:Bind|silent",
                "residual",
                "turn|turn:4",
                ["time"],
                "residual",

...
fn wandering_spirit_swaps_abilities_on_contact() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "abilitystart|mon:Runerigus,player-2,1|ability:Mold Breaker|from:ability:Wandering Spirit",
            ...
            "abilitystart|mon:Runerigus,player-1,1|ability:Wandering Spirit|from:ability:Wandering Spirit|of:Runerigus,player-2,1",
            ...
            "abilitystart|mon:Runerigus,player-1,1|ability:Mold Breaker|from:ability:Wandering Spirit",
            ...
            "abilitystart|mon:Runerigus,player-2,1|ability:Wandering Spirit|from:ability:Wandering Spirit|of:Runerigus,player-1,1",
            "residual",
            "turn|turn:2"
        ]"#,
    )

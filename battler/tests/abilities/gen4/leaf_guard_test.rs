...
fn leaf_guard_prevents_previous_yawn_in_sun() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
                ...
                "abilitystart|mon:Budew,player-1,1|ability:No Ability|source:Budew,player-2,1|from:move:Skill Swap",
                "abilityend|mon:Budew,player-2,1|ability:No Ability|from:move:Skill Swap|of:Budew,player-1,1",
                "abilitystart|mon:Budew,player-2,1|ability:Leaf Guard|source:Budew,player-1,1|from:move:Skill Swap|of:Budew,player-1,1",
                "residual",
                "weather|weather:Harsh Sunlight|residual",

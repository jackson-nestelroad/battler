...
fn klutz_suppresses_item() {
    ...
    let mut battle = make_battle(0, team, lopunny().unwrap()).unwrap();
...
fn klutz_does_not_suppress_power_anklet_even_when_swapped() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "itemstart|mon:Lopunny,player-1,1|item:Toxic Orb|source:Lopunny,player-2,1|from:move:Trick",
            "itemstart|mon:Lopunny,player-2,1|item:Power Anklet|source:Lopunny,player-1,1|from:move:Trick|of:Lopunny,player-1,1",
            "residual",
            "turn|turn:3",
            "continue",
            "move|mon:Lopunny,player-1,1|name:Splash|target:Lopunny,player-1,1",
            ...
            "itemstart|mon:Lopunny,player-1,1|item:Power Anklet|source:Lopunny,player-2,1|from:move:Trick",
            "itemstart|mon:Lopunny,player-2,1|item:Toxic Orb|source:Lopunny,player-1,1|from:move:Trick|of:Lopunny,player-1,1",
            "residual",
            "turn|turn:5",
            "continue",
            "move|mon:Lopunny,player-2,1|name:Splash|target:Lopunny,player-2,1",

...
fn pickup_picks_up_random_used_item() {
    ...
    let mut battle = make_battle(0, player, opponent).unwrap();
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
                ...
                "residual",
                "itemstart|mon:Linoone,player-1,1|item:Cheri Berry|from:ability:Pickup",
                "itemstart|mon:Linoone,player-2,1|item:Rawst Berry|from:ability:Pickup",
                "turn|turn:2",
                "continue",

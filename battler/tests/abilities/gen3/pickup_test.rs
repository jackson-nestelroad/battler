...
fn pickup_picks_up_random_used_item() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "curestatus|mon:Linoone,player-2,1|status:Paralysis",
            ...
            "curestatus|mon:Linoone,player-1,1|status:Burn",
            ...
            "curestatus|mon:Linoone,player-2,1|status:Burn",
            ...
            "curestatus|mon:Linoone,player-1,1|status:Paralysis",
            "item|mon:Linoone,player-1,1|item:Cheri Berry|from:ability:Pickup",
            "item|mon:Linoone,player-2,1|item:Rawst Berry|from:ability:Pickup",
            "residual",
            "turn|turn:3"

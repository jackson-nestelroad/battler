...
fn magcargo() -> Result<TeamData, Error> {
    serde_json::from_str(
        r#"{
            "members": [
                {
...
fn linoone() -> Result<TeamData, Error> {
    serde_json::from_str(
        r#"{
            "members": [
                {
...
fn magma_armor_prevents_freeze() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "endability|mon:Magcargo,player-1,1|ability:Magma Armor|from:move:Skill Swap",
            "ability|mon:Magcargo,player-1,1|ability:No Ability|from:move:Skill Swap|of:Linoone,player-2,1",
            "endability|mon:Linoone,player-2,1|ability:No Ability|from:move:Skill Swap",
            "ability|mon:Linoone,player-2,1|ability:Magma Armor|from:move:Skill Swap|of:Magcargo,player-1,1",
            "activate|mon:Linoone,player-2,1|ability:Magma Armor",
            "curestatus|mon:Linoone,player-2,1|status:Freeze",
            "residual",
            "turn|turn:3"
        ]"#,
    )

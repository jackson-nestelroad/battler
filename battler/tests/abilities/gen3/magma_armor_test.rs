...
fn magma_armor_prevents_freeze() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "endability|mon:Magcargo,player-1,1|ability:Magma Armor|from:move:Skill Swap|of:Linoone,player-2,1",
            "ability|mon:Magcargo,player-1,1|ability:No Ability|from:move:Skill Swap|of:Linoone,player-2,1",
            "endability|mon:Linoone,player-2,1|ability:No Ability|from:move:Skill Swap|of:Magcargo,player-1,1",

...
fn intimidate_lowers_adjacent_foes_attack_on_appearance() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "unboost|mon:Swampert,player-1,1|stat:atk|by:1|from:ability:Intimidate|of:Mightyena,player-2,2",
            "unboost|mon:Mightyena,player-1,2|stat:atk|by:1|from:ability:Intimidate|of:Mightyena,player-2,2",
            "activate|mon:Mightyena,player-1,2|ability:Intimidate",
            "unboost|mon:Swampert,player-2,1|stat:atk|by:1|from:ability:Intimidate|of:Mightyena,player-1,2",
            "unboost|mon:Mightyena,player-2,2|stat:atk|by:1|from:ability:Intimidate|of:Mightyena,player-1,2",
            "turn|turn:1",
            "continue",
            "split|side:0",
            ...
            "unboost|mon:Swampert,player-2,1|stat:atk|by:1|from:ability:Intimidate|of:Mightyena,player-1,1",
            "unboost|mon:Mightyena,player-2,2|stat:atk|by:1|from:ability:Intimidate|of:Mightyena,player-1,1",
            "residual",
            "turn|turn:3"
        ]"#,
    )

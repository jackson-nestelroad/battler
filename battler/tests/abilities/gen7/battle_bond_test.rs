...
fn battle_bond_transforms_into_ash_greninja_and_gives_boost() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "continue",
            "split|side:1",
            "switch|player:player-2|position:1|name:Delphox|health:260/260|species:Delphox|level:100|gender:U",
            "switch|player:player-2|position:1|name:Delphox|health:100/100|species:Delphox|level:100|gender:U",
            "turn|turn:2",
            "continue",

...
fn opportunist_compounds_stat_boosts() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "split|side:1",
            "damage|mon:Espathra,player-2,1|health:96/155",
            "damage|mon:Espathra,player-2,1|health:62/100",
            ...
            "split|side:0",
            "damage|mon:Espathra,player-1,1|health:136/155",
            "damage|mon:Espathra,player-1,1|health:88/100",
            "residual",
            "turn|turn:2"
        ]"#,
    )

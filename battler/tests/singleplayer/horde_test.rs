...
fn player_can_hit_all_adjacent_foes() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "player|id:wild-0|name:Horde|side:1|position:0|wild",
            "player|id:wild-1|name:Horde|side:1|position:1|wild",
            "player|id:wild-2|name:Horde|side:1|position:2|wild",
            "player|id:wild-3|name:Horde|side:1|position:3|wild",
            "player|id:wild-4|name:Horde|side:1|position:4|wild",
            "continue",

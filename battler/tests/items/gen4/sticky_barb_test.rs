...
fn sticky_barb_deals_residual_damage_and_transfers_with_contact() {
    ...
    let mut battle = make_battle(&data, 0, pachirisu().unwrap(), team).unwrap();
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "itemend|mon:Pachirisu,player-1,1|item:Sticky Barb|from:item:Sticky Barb|of:Pachirisu,player-2,1",
            "item|mon:Pachirisu,player-2,1|item:Sticky Barb|from:item:Sticky Barb",
            "split|side:1",
            ...
            "itemend|mon:Pachirisu,player-2,1|item:Sticky Barb|from:item:Sticky Barb|of:Pachirisu,player-1,1",
            "item|mon:Pachirisu,player-1,1|item:Sticky Barb|from:item:Sticky Barb",
            "move|mon:Pachirisu,player-2,1|name:Tackle|target:Pachirisu,player-1,1",
            "split|side:0",

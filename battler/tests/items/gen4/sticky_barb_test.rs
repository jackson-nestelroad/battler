...
fn sticky_barb_deals_residual_damage_and_transfers_with_contact() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
                ...
                "itemstart|mon:Pachirisu,player-2,1|item:Sticky Barb|from:item:Sticky Barb|of:Pachirisu,player-1,1",
                "residual",
                "split|side:1",
                ...
                "itemstart|mon:Pachirisu,player-1,1|item:Sticky Barb|from:item:Sticky Barb|of:Pachirisu,player-2,1",
                "move|mon:Pachirisu,player-2,1|name:Tackle|target:Pachirisu,player-1,1",
                "split|side:0",

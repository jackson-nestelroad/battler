...
fn timer_ball_increases_modifier_as_battle_goes_on() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            "useitem|player:protagonist|name:Timer Ball|target:Graveler,wild,1",
            "catchfailed|player:protagonist|mon:Graveler,wild,1|item:Timer Ball|shakes:3",
            "residual",
            "turn|turn:2",
            "continue",
            "useitem|player:protagonist|name:Timer Ball|target:Graveler,wild,1",

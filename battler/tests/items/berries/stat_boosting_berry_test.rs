...
fn liechi_berry_boosts_attack() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "boost|mon:Oshawott,player-1,1|stat:atk|by:1|from:item:Liechi Berry",
            "residual",
            "turn|turn:2"
        ]"#,
    )
...
fn ganlon_berry_boosts_defense() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "boost|mon:Oshawott,player-1,1|stat:def|by:1|from:item:Ganlon Berry",
            "residual",
            "turn|turn:2"
        ]"#,
    )
...
fn starf_berry_boosts_random_stat() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "boost|mon:Oshawott,player-1,1|stat:atk|by:2|from:item:Starf Berry",
            "itemstart|mon:Oshawott,player-1,1|item:Starf Berry|from:ability:Pickup",
            "residual",
            "itemend|mon:Oshawott,player-1,1|item:Starf Berry|eat",
            ...
            "itemstart|mon:Oshawott,player-1,1|item:Starf Berry|from:move:Recycle",
            "itemend|mon:Oshawott,player-1,1|item:Starf Berry|eat",
            "boost|mon:Oshawott,player-1,1|stat:def|by:2|from:item:Starf Berry",
            "itemstart|mon:Oshawott,player-1,1|item:Starf Berry|from:ability:Pickup",
            "residual",
            "itemend|mon:Oshawott,player-1,1|item:Starf Berry|eat",
            "boost|mon:Oshawott,player-1,1|stat:spa|by:2|from:item:Starf Berry",
            "turn|turn:3"
        ]"#,
    )
    .unwrap();
...
fn kee_berry_boosts_defense_after_hit_by_physical_move() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "boost|mon:Oshawott,player-1,1|stat:def|by:1|from:item:Kee Berry",
            "residual",
            "turn|turn:2"
        ]"#,
    )
...
fn maranga_berry_boosts_special_defense_after_hit_by_special_move() {
    ...
    let expected_logs = serde_json::from_str::<Vec<LogMatch>>(
        r#"[
            ...
            "boost|mon:Oshawott,player-1,1|stat:spd|by:1|from:item:Maranga Berry",
            "residual",
            "turn|turn:2"
        ]"#,
    )
